...
class TestRaps1 extends EnglishTest {
  ...
  { //3 Increase
    ...
    val research = NodeSpec("research and development for new crop cultivars", Inc("boost"))
//    val dev = NodeSpec("development", Inc("boost"))
    val prod = NodeSpec("agricultural production for ensuring food security", Inc("boost"))
