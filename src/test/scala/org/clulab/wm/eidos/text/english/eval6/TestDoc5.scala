...
class TestDoc5 extends EnglishTest {
  ...
  { // Paragraph 6
    ...
    val assistance   = NodeSpec("Little to no food assistance was distributed in these counties from August to November", Quant("Little"), Dec("Little to no"), TimEx("August"))
