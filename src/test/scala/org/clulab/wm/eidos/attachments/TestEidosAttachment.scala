...
class TestEidosAttachment extends Test {
  ...
  {
    behavior of "a Negation"

    val attach1 = new Negation("trigger", Some(Seq("mod1", "mod2")))
    val attach2 = new Negation("trigger", Some(Seq("mod2", "mod1")))
    val attach3 = new Negation("trigger", Some(Seq("mod1", "mod1")))
    val attach4 = new Negation("reggirt", Some(Seq("mod1", "mod2")))
...

  {
    ...
    val attach1d = new Negation("trigger", mod12)
    ...
    val attach2d = new Negation("trigger", mod21)
    ...
    val attach3d = new Negation("trigger", mod11)
    ...
    it should "equal itself" in {
      ...
      HashSet(attach1d) == HashSet(attach1d) should be (true)
    }
    ...
    it should "equal its equivalent" in {
      ...
      HashSet(attach1d) == HashSet(attach2d) should be (true)
    }
    ...
    it should "not be equal if not equivalent" in {
      ...
      HashSet(attach1d) == HashSet(attach3d) should be (false)
    }
    ...
    it should "have equal hashCodes for equal objects" in {
      ...
      attach1d == attach2d should be (attach1d.## == attach2d.##)
      ...
      attach1d == attach3d should be (attach1d.## == attach3d.##)
    }
  }
}
