...
class TestConceptDiscovery extends AnyFlatSpec with Matchers {
  {
    ...
    val texts = Seq(
      Seq(
        ...
        "According the United Nations’ Committee on World Food Security, food security is defined as the means that all people, at all times, have physical, social, and economic access to sufficient, safe, and nutritious food that meets their food preferences and dietary needs for an active and healthy life.[1]",
        ...
        """At the 1974 World Food Conference the term "food security" was defined with an emphasis on supply; food security is defined as the "availability at all times of adequate, nourishing, diverse, balanced and moderate world food supplies of basic foodstuffs to sustain a steady expansion of food consumption and to offset fluctuations in production and prices".[2]""",
        "Later definitions added demand and access issues to the definition.",
        """The final report of the 1996 World Food Summit states that food security "exists when all people, at all times, have physical and economic access to sufficient, safe and nutritious food to meet their dietary needs and food preferences for an active and healthy life."[3][4]"""),
      Seq(
        "Household food security exists when all members, at all times, have access to enough food for an active, healthy life.[5]",
        "Individuals who are food secure do not live in hunger or fear of starvation.[6]",
        """Food insecurity, on the other hand, is defined by the United States Department of Agriculture (USDA) as a situation of "limited or uncertain availability of nutritionally adequate and safe foods or limited or uncertain ability to acquire acceptable foods in socially acceptable ways".[7]""",
    ...
    val concepts = conceptDiscovery.discoverConcepts(documents, None)
