...
object CAG {
  ...
  val p1 = Array(p1s1, p1s2, p1s3, p1s4).mkString(SINGLE_SENTENCE_SEPARATOR)
  ...
  val p2 = Array(Array(p2s1, p2s2).mkString(SINGLE_SENTENCE_SEPARATOR), p2s3, p2s4, p2s5).mkString(DOUBLE_SENTENCE_SEPARATOR)
  ...
  val p4 = Array(p4s1, p4s2, p4s3, p4s4).mkString(SINGLE_SENTENCE_SEPARATOR)
